...
func NewCudnDensityStage(wh *workloads.WorkloadHelper) *cobra.Command {
	...
	var rc int
	cmd := &cobra.Command{
		Use:          "cudn-density-stage",
		Short:        "Runs cudn-density workload with staged object creation and incremental load",
		SilenceUsage: true,
