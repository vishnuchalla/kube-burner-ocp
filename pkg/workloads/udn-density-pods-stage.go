...
func NewUDNDensityPodsStage(wh *workloads.WorkloadHelper) *cobra.Command {
	...
	var rc int
	cmd := &cobra.Command{
		Use:          "udn-density-pods-stage",
		Short:        "Runs udn-density-pods workload with staged object creation and incremental load",
		SilenceUsage: true,
